...
Our research project brings Hollywood's long history of sexism face to face with the the blatent truths that the power of statistics make perfectly clear. The Bechdel Test, designed to measures representaiton of women in film and other fictional media, is responsible for revealing the representational and monitary inequities of the industry. For a movie to pass the test it must feature two female characters who have converstations about a topic other than men. With data from @fivethirtyeight_bechdel movies we uncover the extent of the dilhema which we explore below. 
...
In @tbl-movies_summary we see the that this bar plot visualizes the differnce between average budgets. This origional finding prompted our hypotesis test to explore this difference.\
...
### Fitted Regression Table

```{r}
#| label: tbl-fitted_regression_table
#| tbl-cap: "Fitted Regression Table"
#| eval: true
#| echo: false
#| message: false
