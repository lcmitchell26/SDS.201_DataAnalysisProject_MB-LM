...
#| tbl-cap: "Wrangled Movies Data for Research"
#| eval: true
#| echo: false
#| message: false
...
(include this paragraph or no? since it's already in the data set)
One could also do a breakdown of the average budgets of movie vary between different ‘levels’ of passing the bechdel test. If there is no representation of women, if the women in the movie don’t talk, and if the movie passes all metrics of the bechdel test.

Figure \_\_\_ shows an exploratory analysis of how the domestic gross varies between films that pass/fail the bechdel test, and figure \_\_\_ is another exploratory analysis visualizing the possible link between different levels of passing/failing the bechdel test and a movie’s average budget.
...
ggplot(aes(x=domgross_2013, y= budget_2013, fill = binary))+
  geom_boxplot() +
  labs(x = "Budget 2013",
       y= "Gross Domestic 2013",
